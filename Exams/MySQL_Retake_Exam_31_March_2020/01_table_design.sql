...
insert into addresses (id, address, town, country, user_id) values (58, '015 Goodland Circle', 'Lwowek Slaski', 'Poland', 76);
...
insert into addresses (id, address, town, country, user_id) values (66, '2 Ridge Oak Terrace', 'Thi Tran Yen Cat', 'Vietnam', 6);
...
insert into addresses (id, address, town, country, user_id) values (92, '6 Warrior Road', 'Cox`s Bazar', 'Bangladesh', 85);
